WebsocketRails::EventMap.describe do
  ...
  subscribe :chat_client_connected, to: ChatController, with_method: :client_connected
  subscribe :chat_client_disconnected, to: ChatController, with_method: :client_disconnected
